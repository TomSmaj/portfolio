exports.employmentData = [
    {
        "title": "Application Support Engineer (Level 3)",
        "company": "Q2",
        "website": "https://www.q2.com/",
        "dates": "08/2021 - Present",
        "description": ["Act as the final line of support that receives issues from clients using Q2 bank account opening software", "Troubleshoot frontend (Javascript) and backend (Java) of account opening software, often using locally running instance of the application", "Identify and document bugs/code improvements needed and create detailed Jira tickets for the development team to take action on, with clear indication of what exact resolution is needed", "Manage client infrastructure in AWS (EC2, RDS, S3, Route 53, CloudWatch)", "Work with containerized client environments in Nomad as well as Docker", "Perform frequent MySQL querying to identify trends/issues affecting clients", "Work directly with customers over phone to address issues", "Personally write documentation as new undocumented knowledge arises", "Work with multiple vendor integrations and APIs utilized by Q2 software (Financial Core middleware, KBA APIs, Decisioning APIs, Funding APIs, etc.)", "Use Postman to recreate and diagnose issues arising with Q2 APIs"]
    },
    {
...
exports.skillsData = [
    {
        ...
        "data": [["React", "Node.js", "Express", "MySQL"], ["JavaScript", "HTML", "CSS", "Bootstrap", "Material UI", "MongoDB"], ["Python", "Java"]]
    },
    {
        "category": "Cloud Services",
        "data": [["AWS:", "EC2", "RDS", "S3", "CloudFront", "Amazon Simple Email Service", "Route 53", "Cloud Watch"]]
    },
    {
        "category": "Software",
        "data": [["Git", "Docker", "Postman", "OpenSSL", "Libreswan VPN"], ["Splunk", "Jira", "Confluence", "Bitbucket"]]
    }
]
